                            ...
                            {receipts.length === 0 ? (
                                ...
                                <tr key={receipt.id} className="border-b border-gray-100 hover:bg-gray-50">
                                    <td className="py-3 px-4 text-sm">
                                        <button
                                            onClick={() => history.push(`/receipts/${encodeURIComponent(receipt.id)}`)}
                                    ...
                                    <td className="py-3 px-4 text-sm">{receipt.invoice?.kwh ?? '-'}</td>
                                    <td className="py-3 px-4 text-sm">{receipt.invoice?.tokenAmount ?? '-'}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
