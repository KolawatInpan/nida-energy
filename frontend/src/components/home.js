        ...
        <Space direction="vertical">
          <Card title="Power Consumption" className="head-bar">
            <Space size={[2, 1]} nowrap style={{ width: "100%" }} className="space-hori-div">
              <Col style={{ fontSize: 34 }}>
                <NumberFormat
                  value={landdingValue.power.consumption}
                  displayType={"text"}
              ...
              <Col style={{ textAlign: "right", lineHeight: "10px" }}>
                <span style={{ fontSize: 14 }}>change</span><br /><span className={"number num_energy " + redminus(landdingValue.power.growth)} style={{ fontSize: 16 }}>
                  <NumberFormat
                    value={landdingValue.power.growth}
                    displayType={"text"}
                    thousandSeparator={true}
                    prefix={minussign(landdingValue.power.growth)}
                    decimalScale={2}
                  />%DOD</span>
              </Col>
            </Space>
            <Space size={[2, 1]} nowrap style={{ width: "100%" }} className="space-hori-div">
              <Col style={{ fontSize: 26 }}>
                <NumberFormat
                  value={landdingValue.energy.consumption}
                  displayType={"text"}
                  thousandSeparator={true}
                  prefix={""}
              ...
              <Col style={{ textAlign: "right", lineHeight: "10px" }}>
                <span style={{ fontSize: 14 }}>change</span><br /><span className={"number num_energy " + redminus(landdingValue.energy.growth)} style={{ fontSize: 16 }}>
                  <NumberFormat
                    value={landdingValue.energy.growth}
                    displayType={"text"}
                    thousandSeparator={true}
                    prefix={minussign(landdingValue.energy.growth)}
                    decimalScale={2}
                  />%MOM</span>
              </Col>
            </Space>
          ...
          <Card title="Water Consumption" className="head-bar">
            <Space size={[2, 1]} style={{ width: "100%" }} nowrap className="space-hori-div">
              <Col style={{ fontSize: 34 }}>
                <NumberFormat
                  value={landdingValue.flow.consumption}
                  displayType={"text"}
                  thousandSeparator={true}
                  prefix={""}
                  decimalScale={0}
            ...
            <Space size={[2, 1]} style={{ width: "100%" }} nowrap className="space-hori-div">
              <Col style={{ fontSize: 26 }}>
                <NumberFormat
                  value={landdingValue.water.consumption}
                  displayType={"text"}
                  thousandSeparator={true}
                  prefix={""}
                  decimalScale={0}
              ...
              <Col style={{ textAlign: "right", lineHeight: "10px" }}>
                <span style={{ fontSize: 14 }}>change</span><br /><span className={"number num_water " + redminus(landdingValue.water.growth)} style={{ fontSize: 16 }}>
                  <NumberFormat
                    value={landdingValue.water.growth}
                    displayType={"text"}
                    thousandSeparator={true}
                    prefix={minussign(landdingValue.water.growth)}
                    decimalScale={2}
                  />%DOD</span>
              </Col>
            </Space>
        ...
        <Space direction="vertical">
          <Card className="energy">
            <Space direction="vertical">
              ...
              <Col className={"status " + (curBuild ? statusBuild(curBuild.power.consumption / curBuild?.consumping_people) : "")}>
                {curBuild ? statusBuild(curBuild.power.consumption / curBuild?.consumping_people) : ""} Consumption
              </Col>
              <img className={"consumpimg " + (curBuild ? statusBuild(curBuild.power.consumption / curBuild?.consumping_people) : "")} src={curBuild ? fileBuild(curBuild.power.consumption / curBuild?.consumping_people) : ""} />
            </Space>
          </Card>
          <Space size={[2, 1]} nowrap>
            <Card className="car square-card">
